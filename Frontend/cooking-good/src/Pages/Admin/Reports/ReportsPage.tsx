            ...
            <TableBody>
              {reports.map((report, index) => (
                <TableRow key={report.id}>
                  ...
                  <TableCell>{report.comment.content}</TableCell>
                  <TableCell>{report.comment.creator.name}</TableCell>
                  <TableCell>
                    <Button onClick={() => handleRemoveReport(report.id)}>
                      Usuń zgłoszenie
                    </Button>
                    <Button onClick={() => handleRemoveComment(report)}>
                      Usuń komentarz
                    </Button>
                    <Button
                      onClick={() => {
                        handleRemoveComment(report);
                        handleBlockUser(report.comment.creator._id);
                      }}
                    >
